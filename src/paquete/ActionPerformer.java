...
public class ActionPerformer {
     ...
     */
    public ActionPerformer(Main tpEditor) {
    ...
    public void actionNew() {
        if (tpEditor.documentHasChanged() == true) {   
        ...
        tpEditor.getJFrame().setTitle("Editor de texto");    //nuevo título de la ventana
    ...
    private static JFileChooser getJFileChooser() {
        ...
        fc.setDialogTitle("TextPad :");                           //se le establece un título
